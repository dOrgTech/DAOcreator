...
export enum Events {
  ...
  DAO_CREATE_REM_FOUNDER = "DAO_CREATE_REM_FOUNDER",
...
interface DAO_CREATE_REM_FOUNDER extends PayloadEvent<string, string> {
  type: Events.DAO_CREATE_REM_FOUNDER
}

export const DAO_CREATE_REM_FOUNDER = createPayloadEvent<
  DAO_CREATE_REM_FOUNDER
>(Events.DAO_CREATE_REM_FOUNDER)
